...
export interface SyncResult {
  status: 'syncing' | 'success' | 'failed' | 'unchanged' | 'unavailable' | 'not_in_region' | 'discontinued';
  oldPrice?: number;
  newPrice?: number;
...
export interface ProductGroup {
  ...
  /** sync_status from DB (e.g. 'manual_only') — used for badges */
