      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <Card className="mb-6">
          ...
          <section className="mt-12 space-y-8">
            ...
            {(() => {
              const compareFaqs = [
                { question: 'How do I compare 3D printer filaments side by side?', answer: "According to FilaScope's comparison data, the tool lets you select up to 4 filaments and compare them across every specification — print temperature, bed temperature, density, tensile strength, price per gram, and HueForge TD values. Select filaments from the search bar above, or start with one of the popular comparisons below." },
                { question: 'What specs matter most when comparing filaments?', answer: "FilaScope's specification data shows that the most important filament specs depend on your use case. For general printing, focus on print temperature range, bed adhesion requirements, and price per gram. For functional parts, compare tensile strength, heat deflection temperature, and layer adhesion. For HueForge lithophanes, the TD (Transmission Distance) value is the critical metric — FilaScope is one of the only platforms that includes TD data in comparisons." },
                { question: 'What is the difference between PLA and PETG filament?', answer: "FilaScope's specification data shows that PLA prints at lower temperatures (190–220°C) and is easier for beginners, but has poor heat resistance (~60°C). PETG prints at 220–250°C, offers better impact resistance, UV stability, and heat tolerance (~80°C), making it better for functional or outdoor parts. Based on FilaScope's database of 21,000+ filaments from 57 brands, the average PLA filament costs $19–25/kg while PETG averages $20–28/kg." },
                { question: 'Is PLA or PETG stronger for 3D printing?', answer: "According to FilaScope's comparison data, PETG has higher impact strength and better layer adhesion than PLA, making it stronger for functional parts. However, PLA has higher rigidity and compressive strength. For parts that need to flex without breaking, PETG is stronger. For parts that need to hold their shape under load, PLA can be better. Compare specific filaments on FilaScope to see exact tensile strength values side by side." },
                { question: 'Can I compare filament prices across different stores?', answer: "Yes. Based on FilaScope's real-time price tracking across 15+ stores in 5 regions, when you compare filaments you see the lowest current price for each one, plus price-per-gram calculations to fairly compare different spool sizes. Use the Deals page to find the current lowest prices across all tracked filaments." },
