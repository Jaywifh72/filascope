...
import { ArrowLeft, Search, X, Thermometer, Shield, Zap, Layers, AlertTriangle, CheckCircle, Info } from "lucide-react";
import { 
  MATERIAL_CATEGORIES, 
  MATERIAL_INFO, 
  getMaterialInfo, 
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">Material Comparison</h1>
          <p className="text-muted-foreground">
            Compare properties of different 3D printing materials side by side. Select up to 5 materials.
          </p>
        </div>
