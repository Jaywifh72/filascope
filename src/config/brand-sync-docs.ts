...
export const BRAND_SYNC_DOCS: Record<string, BrandSyncDoc> = {
  ...
  'amolen': {
    ...
    specialBehaviors: [
      { name: 'Material-First Grouping', description: 'TPU, PETG, PLA+ checked BEFORE finish types to prevent cross-material grouping.' },
      ...
      { name: 'TPU Transparent Separation', description: 'TPU transparent products grouped separately from PLA crystal/transparent.' },
    ...
    notes: [
      ...
      '25+ product lines including engineering materials',
