...
export const PRINTING_GLOSSARY: Record<string, GlossaryTerm> = {
  ...
  print_speed: {
    id: 'print_speed',
    title: 'Print Speed',
    description: 'How fast the printhead moves while extruding. Higher speeds = faster prints but may reduce quality. Most materials print well at 40-60mm/s.',
    category: 'movement',
    skillLevel: 'beginner',
    relatedTerms: ['travel_speed', 'acceleration'],
  },
  build_surface: {
    id: 'build_surface',
    title: 'Build Surface',
    description: 'The surface material on the print bed where prints adhere. Options include PEI, glass, BuildTak, and textured plates. Different materials work better with different surfaces.',
    category: 'hardware',
    skillLevel: 'beginner',
    relatedTerms: ['bed_temperature', 'adhesion'],
  },
  adhesion: {
    id: 'adhesion',
    title: 'Bed Adhesion',
    description: 'How well the first layer sticks to the print surface. Affected by bed temp, surface type, Z-offset, and first layer settings. Poor adhesion causes failed prints.',
    category: 'quality',
    skillLevel: 'beginner',
    relatedTerms: ['bed_temperature', 'build_surface', 'first_layer'],
  },
  jerk: {
    id: 'jerk',
    title: 'Jerk',
