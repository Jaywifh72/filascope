 ...
 */
const DEFAULTS = {
  title: 'FilaScope — Compare 22,000+ 3D Printer Filaments | Specs, Prices & TD Values',
  description:
    'Compare 22,000+ 3D printer filaments from 58 brands. Live pricing from 15+ stores, HueForge TD values, printer compatibility & specs. The most comprehensive filament database online.',
  canonical: 'https://filascope.com/',
  ogTitle: 'FilaScope — Compare 22,000+ 3D Printer Filaments | Specs, Prices & TD Values',
  ogDescription: 'Compare 22,000+ 3D printer filaments from 58 brands.',
  ...
  twitterDescription: 'Compare 22,000+ 3D printer filaments from 58 brands.',
