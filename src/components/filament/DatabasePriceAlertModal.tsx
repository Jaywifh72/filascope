...
export function DatabasePriceAlertModal({
  ...
  const { setAlert, removeAlert, getAlert, hasAlert, isSettingAlert } = useDatabasePriceAlerts();
      ...
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Sign in to set price alerts and get notified when prices drop.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="py-6 text-center">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Create a free account to track prices and receive email notifications when your favorite filaments go on sale.
            </p>
