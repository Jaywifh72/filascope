...
const KNOWN_BRAND_SLUGS = ['sunlu', 'anycubic', 'bambu-lab', '3d-fuel', '3dhojor', '3dxtech', 'amolen', 'atomic-filament', 'azurefilm', 'colorfabb', 'creality', 'duramic-3d', 'elegoo', 'eryone', 'esun', 'extrudr', 'fiberlogy', 'fillamentum', 'flsun', 'formfutura', 'fusion-filaments', 'geeetech', 'gizmo-dorks', 'hatchbox', 'ic3d-printers', 'kingroon', 'matter3d', 'ninjatek', 'numakers', 'overture', 'paramount-3d', 'polymaker', 'proto-pasta', 'prusament', 'push-plastic', 'qidi', 'recreus', 'siraya-tech', 'sovol', 'spectrum-filaments', 'treed-filaments'];
