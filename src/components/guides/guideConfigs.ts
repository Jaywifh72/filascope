...
<p><strong>ABS wins when:</strong> You specifically need acetone vapor smoothing, heat deflection above 80°C, or reverse-engineering injection-molded ABS parts.</p>`,
  ...
  'tpu-vs-petg': {
    ...
    seoTitle: 'TPU vs PETG — Difference Between PETG and TPU Filament | FilaScope',
    seoDescription: 'What is the difference between PETG and TPU? Complete comparison of flexibility, strength, temperature settings, printability and use cases for each 3D printer filament.',
    ...
    publishedAt: '2026-02-20',
    updatedAt: '2026-02-20',
    keywords: ['TPU vs PETG', 'difference between PETG and TPU', 'flexible filament vs rigid', 'TPU or PETG', 'TPU filament comparison', 'when to use TPU', 'PETG vs TPU'],
