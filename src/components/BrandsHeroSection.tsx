      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto px-4 sm:px-6 md:px-10 pt-4 pb-1 sm:pt-6 sm:pb-2 md:pt-6 md:pb-3">
        <div className="flex flex-col items-start max-w-3xl">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight leading-[1.15] text-white mb-2">
            3D Filament <span className="text-primary">Brands</span>
          </h1>
          ...
          <p className="text-sm sm:text-base text-gray-400 mb-5 animate-fade-in" style={{ animationDelay: "0.1s" }}>
            {isLoading ? (
              ...
              <>
                <span className="text-primary font-semibold">{brandCount}</span> brands with{' '}
                <span className="text-primary font-semibold">{productCount.toLocaleString()}</span>+ products
                {verifiedCount > 0 && (
                  <>
            ...
            <div className="relative w-full sm:w-auto">
              <div className={`relative transition-all duration-300 ${isFocused ? "scale-[1.01]" : ""}`}>
                ...
                <input
                  ...
                  className={`w-full sm:min-w-[320px] md:min-w-[360px] h-12 pl-11 sm:pl-12 pr-10 text-sm text-foreground placeholder:text-muted-foreground rounded-xl border transition-all duration-200 outline-none ${
                    isFocused
