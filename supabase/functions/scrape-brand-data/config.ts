...
export const BRAND_CONFIGS: Record<string, BrandConfig> = {
  ...
  "TreeD Filaments": {
    ...
    platform: "firecrawl", // Not standard Shopify API
  ...
  "Devil Design": {
    vendor: "Devil Design",
    platform: "woocommerce", // Uses WooCommerce, not Shopify
    baseUrl: "https://devildesign.com",
    apiEndpoint: "https://devildesign.com/wp-json/wc/store/v1/products",
    currency: "EUR",
    exchangeRate: 1.08,
    productsPerPage: 100,
    requestDelay: 1000,
  ...
  Creality: {
    vendor: "Creality",
    platform: "firecrawl", // Custom store, not standard Shopify API
