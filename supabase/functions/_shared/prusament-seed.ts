...
export const PRUSAMENT_PRODUCT_SEED: PrusamentProductSeed[] = [
  ...
  { filamentName: 'Prusament PETG Clear 1kg (NFC)', material: 'PETG', productUrl: 'https://www.prusa3d.com/product/prusament-petg-clear-1kg-nfc/', color: 'Clear', colorHex: '#FFFFFF', weightGrams: 1000, hasNfc: true, isRefill: false },
  { filamentName: 'Prusament PETG Clear 2kg', material: 'PETG', productUrl: 'https://www.prusa3d.com/product/prusament-petg-clear-2kg/', color: 'Clear', colorHex: '#FFFFFF', weightGrams: 2000, hasNfc: false, isRefill: false },
  { filamentName: 'Prusament PETG Clear 2kg (NFC)', material: 'PETG', productUrl: 'https://www.prusa3d.com/product/prusament-petg-clear-2kg-nfc/', color: 'Clear', colorHex: '#FFFFFF', weightGrams: 2000, hasNfc: true, isRefill: false },
  ...
  { filamentName: 'Prusament PETG Sky Blue 1kg (NFC)', material: 'PETG', productUrl: 'https://www.prusa3d.com/product/prusament-petg-sky-blue-1kg-nfc/', color: 'Sky Blue', colorHex: '#0066CC', weightGrams: 1000, hasNfc: true, isRefill: false },
  ...
  { filamentName: 'Prusament PETG Jungle Green 1kg', material: 'PETG', productUrl: 'https://www.prusa3d.com/product/prusament-petg-jungle-green-1kg/', color: 'Jungle Green', colorHex: '#228B22', weightGrams: 1000, hasNfc: false, isRefill: false },
  { filamentName: 'Prusament PETG Jungle Green 1kg (NFC)', material: 'PETG', productUrl: 'https://www.prusa3d.com/product/prusament-petg-jungle-green-1kg-nfc/', color: 'Jungle Green', colorHex: '#228B22', weightGrams: 1000, hasNfc: true, isRefill: false },
  ...
  { filamentName: 'Prusament PETG Clear 900g Refill (NFC Compatible)', material: 'PETG', productUrl: 'https://www.prusa3d.com/product/prusament-petg-clear-900g-refill-nfc-compatible/', color: 'Clear', colorHex: '#FFFFFF', weightGrams: 900, hasNfc: false, isRefill: true },
  ...
  { filamentName: "Prusament PLA Gentleman's Grey 1kg", material: 'PLA', productUrl: 'https://www.prusa3d.com/product/prusament-pla-gentleman-s-grey-1kg/', color: "Gentleman's Grey", colorHex: '#808080', weightGrams: 1000, hasNfc: false, isRefill: false },
  { filamentName: "Prusament PLA Gentleman's Grey 1kg (NFC)", material: 'PLA', productUrl: 'https://www.prusa3d.com/product/prusament-pla-gentleman-s-grey-1kg-nfc/', color: "Gentleman's Grey", colorHex: '#808080', weightGrams: 1000, hasNfc: true, isRefill: false },
