...
export const COLORFABB_PRODUCT_SEED: ColorFabbProductSeed[] = [
  // varioShore TPU → TPU material for filtering
  { material: 'TPU', filamentLine: 'varioShore TPU', color: 'BLACK', productName: 'VARIOSHORE TPU BLACK', productUrl: 'https://colorfabb.us/varioshore-tpu-black', imageUrl: 'https://colorfabb.us/media/catalog/product/v/a/varioshore_tpu_black.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=500&width=500&canvas=500:500', sku: '060004', priceUsd: 59.70 },
  { material: 'TPU', filamentLine: 'varioShore TPU', color: 'NATURAL', productName: 'VARIOSHORE TPU NATURAL', productUrl: 'https://colorfabb.us/varioshore-tpu-natural', imageUrl: 'https://colorfabb.us/media/catalog/product/v/a/varioshore_tpu_natural.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=500&width=500&canvas=500:500', sku: '060003', priceUsd: 59.70 },
  { material: 'TPU', filamentLine: 'varioShore TPU', color: 'RED', productName: 'VARIOSHORE TPU RED', productUrl: 'https://colorfabb.us/varioshore-tpu-red', imageUrl: 'https://colorfabb.us/media/catalog/product/v/a/varioshore_tpu_red.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=500&width=500&canvas=500:500', sku: '060006', priceUsd: 59.70 },
  { material: 'TPU', filamentLine: 'varioShore TPU', color: 'GREEN', productName: 'VARIOSHORE TPU GREEN', productUrl: 'https://colorfabb.us/varioshore-tpu-green', imageUrl: 'https://colorfabb.us/media/catalog/product/v/a/varioshore_tpu_green.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=500&width=500&canvas=500:500', sku: '060008', priceUsd: 59.70 },
  { material: 'TPU', filamentLine: 'varioShore TPU', color: 'BLUE', productName: 'VARIOSHORE TPU BLUE', productUrl: 'https://colorfabb.us/varioshore-tpu-blue', imageUrl: 'https://colorfabb.us/media/catalog/product/v/a/varioshore_tpu_blue.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=500&width=500&canvas=500:500', sku: '060007', priceUsd: 59.70 },
  { material: 'TPU', filamentLine: 'varioShore Prosthetic', color: 'NATURAL', productName: 'VARIOSHORE PROSTHETIC NATURAL', productUrl: 'https://colorfabb.us/varioshore-prosthetic', imageUrl: 'https://colorfabb.us/media/catalog/product/v/a/varioshore_tpu_prosthetic_natural.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=500&width=500&canvas=500:500', sku: '060009', priceUsd: 59.70 },
  { material: 'TPU', filamentLine: 'varioShore Prosthetic', color: 'DARK BROWN', productName: 'VARIOSHORE PROSTHETIC DARK BROWN', productUrl: 'https://colorfabb.us/varioshore-tpu-dark-brown', imageUrl: 'https://colorfabb.us/media/catalog/product/v/a/varioshore_tpu_prosthetic_dark-brown.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=500&width=500&canvas=500:500', sku: '060010', priceUsd: 59.70 },
  { material: 'TPU', filamentLine: 'varioShore Prosthetic', color: 'MEDIUM BROWN', productName: 'VARIOSHORE PROSTHETIC MEDIUM BROWN', productUrl: 'https://colorfabb.us/varioshore-tpu-medium-brown', imageUrl: 'https://colorfabb.us/media/catalog/product/v/a/varioshore_tpu_prosthetic_medium-brown.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=500&width=500&canvas=500:500', sku: '060011', priceUsd: 59.70 },
  { material: 'TPU', filamentLine: 'varioShore Prosthetic', color: 'PALE PINK', productName: 'VARIOSHORE PROSTHETIC PALE PINK', productUrl: 'https://colorfabb.us/varioshore-prosthetic-pale-pink', imageUrl: 'https://colorfabb.us/media/catalog/product/v/a/varioshore_tpu_prosthetic_pale-pink.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=500&width=500&canvas=500:500', sku: '060012', priceUsd: 59.70 },
...
const MATERIAL_PATTERNS: Array<{ pattern: RegExp; info: MaterialInfo }> = [
  ...
  { pattern: /\bvarioshore\b/i, info: { normalized: 'TPU', baseType: 'TPU', isAbrasive: false, enclosureRequired: false, isFoaming: true, isFlexible: true, highSpeedCapable: false } },
  ...
  { pattern: /\bxt[- ]?cf\s*20\b/i, info: { normalized: 'Copolyester', baseType: 'PETG', isAbrasive: true, enclosureRequired: false, isFoaming: false, isFlexible: false, highSpeedCapable: false } },
