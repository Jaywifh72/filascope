...
export const COLORFABB_PRODUCT_SEED: ColorFabbProductSeed[] = [
  ...
  // XT
  { material: 'XT', filamentLine: 'XT', color: 'LIGHT BLUE', productName: 'XT LIGHT-BLUE', productUrl: 'https://colorfabb.us/xt-light-blue', imageUrl: 'https://colorfabb.us/media/catalog/product/x/t/xt_light-blue.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=500&width=500&canvas=500:500', sku: '020008', priceUsd: 35.71 },
  { material: 'XT', filamentLine: 'XT', color: 'WHITE', productName: 'XT WHITE', productUrl: 'https://colorfabb.us/xt-white', imageUrl: 'https://colorfabb.us/media/catalog/product/x/t/xt_white.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=500&width=500&canvas=500:500', sku: '020002', priceUsd: 35.71 },
  { material: 'XT', filamentLine: 'XT', color: 'BLACK', productName: 'XT BLACK', productUrl: 'https://colorfabb.us/xt-black', imageUrl: 'https://colorfabb.us/media/catalog/product/x/t/xt_black.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=500&width=500&canvas=500:500', sku: '020010', priceUsd: 35.71 },
  { material: 'XT', filamentLine: 'XT', color: 'LIGHT GRAY', productName: 'XT LIGHT GRAY', productUrl: 'https://colorfabb.us/xt-light-gray', imageUrl: 'https://colorfabb.us/media/catalog/product/x/t/xt_light-gray.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=500&width=500&canvas=500:500', sku: '020030', priceUsd: 35.73 },
  { material: 'XT', filamentLine: 'XT', color: 'DARK GRAY', productName: 'XT DARK GRAY', productUrl: 'https://colorfabb.us/xt-dark-gray', imageUrl: 'https://colorfabb.us/media/catalog/product/x/t/xt_dark-gray.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=500&width=500&canvas=500:500', sku: null, priceUsd: null },
  
  // XT-CF20
  { material: 'XT-CF20', filamentLine: 'XT-CF20', color: 'BLACK', productName: 'XT-CF20', productUrl: 'https://colorfabb.us/xt-cf20', imageUrl: 'https://colorfabb.us/media/catalog/product/x/t/xt_cf20.png?optimize=medium&bg-color=255,255,255&fit=bounds&height=500&width=500&canvas=500:500', sku: null, priceUsd: null },
