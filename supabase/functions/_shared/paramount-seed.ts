...
export const PARAMOUNT_SEED_DATA: ParamountSeedEntry[] = [
  ...
  { material: 'PLA', filamentLine: 'PLA (Aztec Gold) 1.75mm 1kg Filament', productUrl: 'https://www.paramount-3d.com/product-page/paramount-3d-aztec-gold', color: 'Aztec Gold', imageUrl: '', colorHex: '#C9B037' },
  { material: 'PLA', filamentLine: 'PLA (Master Spool) 1.75mm 1kg Filament', productUrl: 'https://www.paramount-3d.com/product-page/paramount-3d-pla-filament-1-75-mm-pla-1-kg-master-spool', color: 'Master Spool', imageUrl: '', colorHex: '#808080' },
  ...
  { material: 'PLA', filamentLine: 'PLA (Karnak Sandstone) 1.75mm 1kg Filament', productUrl: 'https://www.paramount-3d.com/product-page/pla-karnak-sandstone-1-75mm-1kg-filament-gbrl10197530s', color: 'Karnak Sandstone', imageUrl: '', colorHex: '#C2B280' },
  ...
  { material: 'PLA', filamentLine: 'PLA (Great Depression Jadeite) 1.75mm 1kg Filament', productUrl: 'https://www.paramount-3d.com/product-page/pla-jade-green-1-75mm-1kg-filament-jgrl60217494c', color: 'Great Depression Jadeite', imageUrl: '', colorHex: '#00A86B' },
  ...
  { material: 'PLA', filamentLine: 'PLA (Skin - Fair Complexion) 1.75mm 1kg Filament', productUrl: 'https://www.paramount-3d.com/product-page/pla-skin-fair-complexion-1-75mm-1kg-filament-lirl1015468c', color: 'Skin - Fair Complexion', imageUrl: '', colorHex: '#FFE0BD' },
