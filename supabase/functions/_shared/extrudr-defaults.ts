...
export const EXTRUDR_COLOR_MAPPING: Record<string, string> = {
  ...
  'natural': '#E3D9C6',
  'metallic': '#4D4C50',
  'metallic grey': '#7A7E89',
  
  // BioFusion Specialty Colors
  'venom green': '#ABBC2E',
  'epic purple': '#6633CC',
  'inca gold': '#E3BB33',
  'steampunk copper': '#DB8447',
  'quicksilver': '#B1BBCB',
  'cherry red': '#DC565E',
  'blue fire': '#416CD6',
  'reptile green': '#00AA48',
  'arctic white': '#E5F1EC',
  ...
  'olive': '#808000',
  'emerald': '#50C878',
  'emerald green': '#289438',
  'grass green': '#7CFC00',
  'neon green': '#98FA42',
  'military green': '#5F7059',
  ...
  'transparent yellow': '#F9A800',
  'transparent orange': '#D05D28',
