...
export const COLOR_FAMILY_MAP: Record<string, string> = {
  ...
  'translucent grey': 'Gray',
  'translucent gray': 'Gray',
  'translucent brown': 'Brown',
  'translucent olive': 'Green',
  'translucent olive green': 'Green',
  'clear': 'Clear',
  'crystal clear': 'Clear',
  'ultra clear': 'Clear',
  'water clear': 'Clear',
  ...
  // ==================== FILLAMENTUM-SPECIFIC COLOR FAMILIES ====================
  // Specialty color names used by Fillamentum brand
  'volcanic dust': 'Gray',
  'cinnamon': 'Brown',
  'light wood tone': 'Brown',
  'southern pine': 'Yellow',          // Light wood/yellow tone
  'rosewood': 'Brown',
  'redheart': 'Red',
  'mukha': 'Brown',
  'turkey egg': 'Gray',               // Speckled gray-blue
  'greedy dragon': 'Green',
  'sea wave': 'Blue',
  'wizards voodoo': 'Purple',         // Alias without apostrophe
  'vertigo galaxy': 'Purple',
  'vertigo jade': 'Green',
  'vertigo mystique': 'Purple',
  'vertigo cherry': 'Red',
  'vertigo grey': 'Gray',
  'vertigo starlight': 'Black',
  'vertigo gold': 'Gold',
  'vertigo blue': 'Blue',
  'vertigo red': 'Red',
  'witch please': 'Purple',
  ...
  'traffic grey': 'Gray',
  'traffic magenta': 'Pink',
  'traffic violet': 'Purple',
  'traffic green': 'Green',
  'traffic blue': 'Blue',
  'signal blue': 'Blue',
  'signal green': 'Green',
  ...
  'signal white': 'White',
  'signal violet': 'Purple',
  'pearl white': 'White',
  'pearl ruby red': 'Red',
  'pearl night blue': 'Blue',
  'noble blue': 'Blue',
  ...
  'ruby red': 'Red',
  'purple red': 'Red',
  'luminous green': 'Green',
  'luminous orange': 'Orange',
  'luminous red': 'Red',
  'luminous yellow': 'Yellow',
  'pistachio green': 'Green',
  'jungle green': 'Green',
  'leaf green': 'Green',
  'turquoise green': 'Green',
  'abu dhabi green': 'Green',
  'aloe green': 'Green',
  'green grass': 'Green',
  'concrete green': 'Green',
  'tangerine orange': 'Orange',
  'calendula orange': 'Orange',
  'melon yellow': 'Yellow',
  'dijon mustard': 'Yellow',
  'chocolate brown': 'Brown',
  'leather brown': 'Brown',
  'caramel brown metallic': 'Brown',
  'powder beige': 'Brown',
  'gold happens': 'Gold',
  'cairo gold': 'Gold',
  'gold cloud': 'Gold',
  'copper with me': 'Brown',
  'rapunzel silver': 'Gray',
  'everybodys magenta': 'Pink',
  'flirty plum': 'Purple',
  'vivid pink': 'Pink',
  'marrakesh red': 'Red',
  'mistake blue metallic': 'Blue',
  'ufo blue metallic': 'Blue',
  'flash yellow metallic': 'Yellow',
  'jungle green metallic': 'Green',
  // Transparent color families
  'iced coffee transparent': 'Brown',
  'apple green transparent': 'Green',
  'limeade transparent': 'Green',
  'bottle green transparent': 'Green',
  'grass green transparent': 'Green',
  'pastel green transparent': 'Green',
  'champagne transparent': 'Yellow',
  'beer transparent': 'Yellow',
  'mandarin orange transparent': 'Orange',
  'cobalt blue transparent': 'Blue',
  'voodoo black transparent': 'Black',
  'grey mouse transparent': 'Gray',
  'deep sea transparent': 'Blue',
  'iced green transparent': 'Green',
  'lagoon transparent': 'Blue',
  'lemonade translucent': 'Yellow',
  'morning sun transparent': 'Yellow',
  'red hood transparent': 'Red',
  'fresh poison transparent': 'Green',
  'bunny blue transparent': 'Blue',
  'pink blush transparent': 'Pink',
  'neon pink transparent': 'Pink',
  'neon yellow transparent': 'Yellow',
  'neon orange transparent': 'Orange',
  'blue transparent': 'Blue',
  'lemon yellow transparent': 'Yellow',
  'pink lollipop transparent': 'Pink',
