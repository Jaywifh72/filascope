...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const EXPECTED_CARD_COUNTS: Record<string, number> = {
      ...
      'spectrum-filaments': 67, // Updated: 67 product lines (PLA Premium, PLA Silk, PLA Magic SILK, Pastello PLA, PETG Premium, ASA 275, PC 275, FlameGuard, S-Flex, Wood, PC PTFE, PPS AM230, ThermaTech PA, PET-G FR V0, ABS Medical + ReFill variants)
