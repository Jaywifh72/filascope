...
const BRAND_STORE_CONFIGS: Record<string, {
  ...
  'QIDI Tech': {
    ...
    is_shopify: true,
    compatibility_pattern: /X-Plus|X-Max|X-Smart|Q1|X-CF|Max4|Plus4/i,
    ...
    hardcoded_nozzles: [
      // ========== X-PLUS 3/X-MAX 3 NOZZLES ==========
      {
        ...
        specs: { 
          ...
          flow_rate: 'High', 
          wear_rating: 'Standard',
          thread_type: 'QIDI (proprietary)',
          mounting_interface: 'X-Plus 3/X-Max 3 quick-swap',
          hotend_system: 'QIDI X-Plus 3',
          thermistor_type: 'NTC 100K',
          heatbreak_material: 'Bi-metal (titanium/copper)',
          heater_cartridge: { voltage: 24, wattage: 60 },
          supported_filament_types: ['PLA', 'PETG', 'ASA', 'ABS', 'TPU'],
      ...
      },
      {
        ...
        specs: { 
          ...
          heater_cartridge: { voltage: 24, wattage: 60 },
          supported_filament_types: ['PLA', 'PETG', 'ASA', 'ABS', 'TPU'],
          special_features: ['Quick-swap hotend', 'Very high flow', 'Enclosed chamber compatible']
        },
        product_url: 'https://qidi3d.com/products/x-plus-3-nozzle',
        image_url: 'https://cdn.shopify.com/s/files/1/0600/3066/4905/files/xplus3-nozzle_600x.png',
        price: 12.99,
      ...
      },
      {
        ...
        specs: { 
          ...
          heater_cartridge: { voltage: 24, wattage: 60 },
          supported_filament_types: ['PLA', 'PETG', 'ASA', 'ABS', 'PC', 'PA', 'CF-PLA', 'CF-PETG', 'CF-PA', 'GF-PA', 'Abrasives'],
          special_features: ['Quick-swap hotend', 'Abrasive-resistant', 'Enclosed chamber compatible']
        },
        product_url: 'https://qidi3d.com/products/x-plus-3-nozzle',
        image_url: 'https://cdn.shopify.com/s/files/1/0600/3066/4905/files/xplus3-nozzle_600x.png',
        price: 18.99,
      ...
      // ========== MAX4/PLUS4 NOZZLES ==========
      {
        name: '0.4mm Brass Nozzle (Max4/Plus4)',
        brand: 'QIDI Tech',
        model: 'Max4-Brass-0.4',
        specs: { 
          diameter_mm: 0.4, 
          material: 'brass', 
          hardened: false, 
          ...
          flow_rate: 'High', 
          wear_rating: 'Standard',
          thread_type: 'QIDI Max4 (proprietary)',
          mounting_interface: 'Max4/Plus4 quick-swap',
          hotend_system: 'QIDI Max4',
          thermistor_type: 'NTC 100K',
          heatbreak_material: 'Bi-metal (titanium/copper)',
          heater_cartridge: { voltage: 24, wattage: 65 },
          supported_filament_types: ['PLA', 'PETG', 'ASA', 'ABS', 'TPU', 'PC', 'PA'],
          special_features: ['Quick-swap hotend', 'High flow', 'Active chamber heating compatible']
        },
        product_url: 'https://qidi3d.com/products/max4-nozzle',
        image_url: 'https://cdn.shopify.com/s/files/1/0600/3066/4905/files/max4-nozzle_600x.png',
        price: 14.99,
        currency: 'USD',
        description: 'High-flow brass nozzle for Max4 and Plus4',
        compatible_printer_brands: ['QIDI Tech'],
        printer_compatibility_pattern: /Max4|Plus4|Max 4|Plus 4/i,
      },
      {
        name: '0.6mm Brass Nozzle (Max4/Plus4)',
        brand: 'QIDI Tech',
        model: 'Max4-Brass-0.6',
        specs: { 
          diameter_mm: 0.6, 
          material: 'brass', 
          hardened: false, 
          ...
          heater_cartridge: { voltage: 24, wattage: 65 },
          supported_filament_types: ['PLA', 'PETG', 'ASA', 'ABS', 'TPU', 'PC', 'PA'],
          special_features: ['Quick-swap hotend', 'Very high flow', 'Active chamber heating compatible']
        },
        product_url: 'https://qidi3d.com/products/max4-nozzle',
        image_url: 'https://cdn.shopify.com/s/files/1/0600/3066/4905/files/max4-nozzle_600x.png',
        price: 14.99,
        currency: 'USD',
        description: 'Fast printing brass nozzle for Max4 and Plus4',
        compatible_printer_brands: ['QIDI Tech'],
        printer_compatibility_pattern: /Max4|Plus4|Max 4|Plus 4/i,
      },
      {
        name: '0.4mm Hardened Steel Nozzle (Max4/Plus4)',
        brand: 'QIDI Tech',
        model: 'Max4-HS-0.4',
        specs: { 
          diameter_mm: 0.4, 
          ...
          heater_cartridge: { voltage: 24, wattage: 65 },
          supported_filament_types: ['PLA', 'PETG', 'ASA', 'ABS', 'PC', 'PA', 'CF-PLA', 'CF-PETG', 'CF-PA', 'GF-PA', 'Abrasives'],
          special_features: ['Quick-swap hotend', 'Abrasive-resistant', 'Active chamber heating compatible']
        },
        product_url: 'https://qidi3d.com/products/max4-nozzle',
        image_url: 'https://cdn.shopify.com/s/files/1/0600/3066/4905/files/max4-nozzle_600x.png',
        price: 19.99,
