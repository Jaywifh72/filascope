 ...
 *   brand_slug = 'atomic-filament', platform_type = 'shopify',
 *   base_url = 'https://atomicfilament.com', scraping_enabled = true
 */

import { createClient } from 'https://esm.sh/@supabase/supabase-js@2';

const BRAND_SLUG = 'atomic-filament';
